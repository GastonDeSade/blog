...
Ce n'est pas le sujet de cet article, mais n'hésite pas à consulter mon article sur les libs que j'utilise: [astro-tools](/blog/astro-tools/) et la [documentation officielle d'Astro](https://docs.astro.build) pour plus de détails.
...
J'ai écrit un article complet à ce sujet: [Astro & GitHub Actions : CI/CD simplifié](/blog/astro-cicd-github/).
...
Deploiement avec GitHub Pages : [Astro + GitHub Pages](https://docs.astro.build/en/guides/deploy/github-pages/)