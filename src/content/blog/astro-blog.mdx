...
Ce n'est pas le sujet de cet article, mais n'hésite pas à consulter mon article sur les libs que j'utilise: <a href={isProd ? '/blog/blog/astro-tools/' : '/blog/astro-tools/'}>astro-tools</a> et la [documentation officielle d'Astro](https://docs.astro.build) pour plus de détails.
